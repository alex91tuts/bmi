...
const MeasurementTypeDialog = ({ open, handleClose, type, onSave }) => {
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <h3 className="text-lg font-medium leading-6 text-gray-900" id="modal-title">
              {type ? 'Edit Measurement Type' : 'Add New Measurement Type'}
            </h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#833AB4] focus:ring-[#833AB4] sm:text-sm p-3"
                  />
                </div>
              </div>
